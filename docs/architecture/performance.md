...
commits the refreshed table directly to the default branch. Do not edit it by
hand. See the
...
committed directly to the default branch after the PR merges. The numbers
therefore track the actual measured throughput of the branch under review
rather than committed state, a manually pasted table, or specific PR text.
