...
- [Cross-Platform Compatibility skill](../../shell-and-powershell/references/cross-platform-compatibility.md) - Path handling across OSes
- [Git Workflow Robustness skill](./git-workflow-robustness.md) - Git operations in CI
