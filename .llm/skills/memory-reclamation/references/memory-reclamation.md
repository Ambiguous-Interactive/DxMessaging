...
- [High-Performance Cache with Eviction Policies](../../cache-eviction/references/cache-eviction-policies.md)
- [Cache Builder Configuration](../../cache-eviction/references/cache-eviction-builder.md)
- [Array Pooling](../../collection-pooling/references/array-pooling.md)
- [Collection Pooling](../../collection-pooling/references/collection-pooling.md)
