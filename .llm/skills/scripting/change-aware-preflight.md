...
| Markdown (`.md`)                                                                                             | `node scripts/run-staged-md-pipeline.js <md>` (normalize/fix/lint/validate markdown)                                                | Run `node scripts/normalize-docs-ascii.js <md>` and `node scripts/fix-md029-md051.js <md>` to auto-fix. Use full `https://github.com/.../blob/master/...` URLs when links from `docs/` target paths outside `docs/`.                                                                   |
