...
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.5.0   | 2026-06-04 | Switched native pre-push to the fast range-aware `run-native-prepush.js` path and moved exhaustive parity to CI/manual `npm run preflight:pre-push`; retired pre-push stamp dependence.                                                                               |
