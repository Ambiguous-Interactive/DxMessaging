...
- [MessageAwareComponent Base-Call Contract](../../unity-editor-conventions/references/base-call-contract.md) -- the analyzer + IL-scanner contract whose output the inspector overlay renders.
