...
- [IEquatable Usage Examples](./iequatable-implementation-usage.md) - Full equality pattern
- [Aggressive Inlining](../../dispatch-hot-path/references/aggressive-inlining.md) - When to use MethodImpl
