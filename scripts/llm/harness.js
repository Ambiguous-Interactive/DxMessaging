...
// Every written file carries this marker; marker-scoped reaping preserves hand-authored mirrors.
...
function mirrorContent(skill) {
  // Carry every discovery field so Claude Code and Codex load the same values as the source.
  ...
  return [
    ...
    "",
    `Read that file and follow it.${skill.references?.length > 0 ? " Supporting detail is in the sibling `references/` directory." : ""}`,
    ""
  ].join("\n");
}
