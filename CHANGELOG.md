...
- Fix corrupted boxed struct payloads in untyped dispatch and preserve class-message identity
  ([#527](https://github.com/Ambiguous-Interactive/DxMessaging/issues/527)).
